...
@section('content')
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{ asset('assets') }}/images/img_2.jpg');">
    <div class="container">
            ...
            <div class="col-md-12 col-lg-10">
                <div class="post-entry text-center">
                    ...
                    <div class="post-meta align-items-center text-center">
                        <figure class="author-figure mb-0 mr-3 d-inline-block"><img src=" {{ asset('assets')
                    }}/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="post-content-body">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium nam quas inventore, ut iure iste
                        modi eos adipisci ad ea itaque labore earum autem nobis et numquam, minima eius. Nam eius, non unde ut
                    ...
                    <p>Quis eius aspernatur, eaque culpa cumque reiciendis, nobis at earum assumenda similique ut? Aperiam vel
                        ...
                        provident ullam tempora error repudiandae sapiente illum rerum itaque voluptatem. Commodi, sequi.</p>
                    <div class="row mb-5 mt-5">
                        <div class="col-md-12 mb-4">
                            <img src=" {{ asset('assets') }}/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src=" {{ asset('assets') }}/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src=" {{ asset('assets') }}/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                    </div>
                    <p>Quibusdam autem, quas molestias recusandae aperiam molestiae modi qui ipsam vel. Placeat tenetur
                        ...
                        quisquam reiciendis, minus, animi minima eum officia doloremque repellat eos, odio doloribus cum.</p>
                    <p>Temporibus quo dolore veritatis doloribus delectus dolores perspiciatis recusandae ducimus, nisi quod,
                        ...
                        necessitatibus nisi cupiditate, quas repellat itaque molestias sit libero voluptas eveniet omnis illo
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus magni explicabo id molestiae,
            ...
            <div class="col-md-12 col-lg-4 sidebar">
                ...
                <div class="sidebar-box">
                    <div class="bio text-center">
                        <img src=" {{ asset('assets') }}/images/person_2.jpg" alt="Image Placeholder" class="img-fluid mb-5">
                        <div class="bio-body">
                            <h2>Craig David</h2>
                ...
                <div class="sidebar-box">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            ...
                            <li>
                                <a href="">
                                    <img src=" {{ asset('assets') }}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                                    <div class="text">
                                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                        <div class="post-meta">
                                            <span class="mr-2">March 15, 2018 </span>
    ...
    <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
            ...
            <div class="col-md-5 order-md-2">
                <a href="single.html" class="hentry img-1 h-100 gradient" style="background-image: url('{{ asset('assets') }}/images/img_4.jpg');">
            ...
            <div class="col-md-7">
                ...
                <a href="single.html" class="hentry img-2 v-height mb30 gradient" style="background-image: url('{{ asset('assets') }}/images/img_1.jpg');">
                ...
                <div class="two-col d-block d-md-flex">
                    <a href="single.html" class="hentry v-height img-2 gradient" style="background-image: url('{{ asset('assets') }}/images/img_2.jpg');">
                    ...
                    <a href="single.html" class="hentry v-height img-2 ml-auto gradient" style="background-image: url('{{ asset('assets') }}/images/img_3.jpg');">
