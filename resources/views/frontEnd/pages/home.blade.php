                ...
                <div class="row align-items-stretch retro-layout-2">
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient"
                            style="background-image: url('{{ asset('assets') }}/images/img_1.jpg');">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                            style="background-image: url('{{ asset('assets') }}/images/img_2.jpg');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry img-5 h-100 gradient"
                            style="background-image: url('{{ asset('assets') }}/images/img_v_1.jpg');">
                    ...
                    <div class="col-md-4">
                        <a href="single.html" class="h-entry mb-30 v-height gradient"
                            style="background-image: url('{{ asset('assets') }}/images/img_3.jpg');">
                        ...
                        <a href="single.html" class="h-entry v-height gradient"
                            style="background-image: url('{{ asset('assets') }}/images/img_4.jpg');">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('assets') }}/images/img_1.jpg" alt="Image"
                            ...
                            <div class="excerpt">
                                ...
                                <div class="post-meta align-items-center text-left clearfix">
                                    <figure class="author-figure mb-0 mr-3 float-left"><img
                                            src="{{ asset('assets') }}/images/person_1.jpg" alt="Image"
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('assets') }}/images/img_2.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('assets') }}/images/img_3.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                            <div class="excerpt">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="{{ asset('assets') }}/images/img_4.jpg" alt="Image"
                                    class="img-fluid rounded"></a>
                            <div class="excerpt">
